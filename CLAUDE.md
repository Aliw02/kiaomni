...
| `d:/MyFolder/ProgrammingWith-Python/Ai/A+/.claude/skills/` | Custom Claude Code skills |
...
- Memory MCP persists facts: ask Claude to "remember X" and it survives sessions
