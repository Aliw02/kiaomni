...
# Prepare expected answers JSON for all 4 context lengths (schema compatible with grade_export.py)
expected_story = {
    "4k": [
        {
            "id": "Q1",
            ...
            "expected_answer": "alpha=0.6, beta=0.2, gamma=0.2",
            "match": "substring"
        },
        {
            "id": "Q2",
        ...
        },
        {
            ...
            "expected_answer": "attn_weight = beta(2 + importance",
            "match": "substring"
        },
        {
            "id": "Q4",
            ...
            "expected_answer": "A2, A3, B2, B4, B5",
            "match": "substring"
        },
        {
            "id": "Q5",
        ...
        },
        {
            ...
            "expected_topics": ["TurboCD priority", "17 charges", "Defense responses", "Court rulings", "Score progression"]
        }
    ],
    "8k": [
        {
        ...
        },
        {
            ...
            "expected_answer": "TurboCD won only 2 of 7 domains",
            "match": "substring"
        },
        {
            "id": "Q4",
        ...
        },
        {
            ...
            "expected_answer": "alpha=0, beta=0, gamma=1.0",
            "match": "substring"
        },
        {
            "id": "Q6",
            ...
            "expected_topics": ["TurboCD flaws", "Cold start problem", "D-005 findings", "TF-Cache BM25 formula", "DW-1 grid search"]
        }
    ],
    "16k": [
        {
        ...
        },
        {
            ...
            "expected_topics": ["Must-Admit vs Admission Gate", "Belady Oracle bounds", "DualTime efficiency", "Workload DNA", "Domain specialization"]
        }
    ],
    "32k": [
        {
        ...
        },
        {
            ...
            "expected_topics": ["TurboCD review", "TF-Cache", "KiaCachePlusR", "Paged Attention", "KiaOmni supremacy"]
        }
    ]
}
