...
Outputs:
    experiments/results/033_full_comparison_results/results.json
    experiments/results/033_full_comparison_results/predictions.csv
    experiments/results/033_full_comparison_results/speed_vram.csv
    experiments/results/033_full_comparison_results/eviction_coherence_loss.csv
    experiments/results/033_full_comparison_results/checkpoints/
"""
...
OUT_DIR  = Path("results/033_full_comparison_results")
